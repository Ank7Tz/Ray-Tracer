...
type Material struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	Albedo          []float32              `protobuf:"fixed32,1,rep,packed,name=albedo,proto3" json:"albedo,omitempty"`
	Fuzz            float32                `protobuf:"fixed32,2,opt,name=fuzz,proto3" json:"fuzz,omitempty"`
	RefractionIndex float32                `protobuf:"fixed32,3,opt,name=refraction_index,json=refractionIndex,proto3" json:"refraction_index,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
const file_ray_tracer_proto_rawDesc = "" +
	...
	"\x04data\x18\x03 \x01(\fR\x04data\"\x94\x01\n" +
	"\bMaterial\x12\x16\n" +
	"\x06albedo\x18\x01 \x03(\x02R\x06albedo\x12\x12\n" +
	"\x04fuzz\x18\x02 \x01(\x02R\x04fuzz\x12)\n" +
	"\x10refraction_index\x18\x03 \x01(\x02R\x0frefractionIndex\"1\n" +
	"\x04Type\x12\x0e\n" +
	"\n" +
	...
	"\tWorldData\x127\n" +
	"\rhittable_list\x18\x01 \x03(\v2\x12.ray_tracer.SphereR\fhittableList2\x12\n" +
	"\x10worldDataServiceB%Z#github.com/Ank7Tz/Ray-Tracer/serverb\x06proto3"
...
var file_ray_tracer_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
...
var file_ray_tracer_proto_depIdxs = []int32{
	2, // 0: ray_tracer.Sphere.mat:type_name -> ray_tracer.Material
	3, // 1: ray_tracer.WorldData.hittable_list:type_name -> ray_tracer.Sphere
